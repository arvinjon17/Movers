  ...
  <nav
    ...
    <div class="container-fluid">
      ...
      <div style="margin-left: 4%;">
        <i class="fas fa-home fa-fw me-3"></i><span>Home > <b>Booking & Payment History</b></span>
      </div>
...
<main style="margin-top: 6%;">
    ...
    <div style="margin: 3% 3% 3% 3%; padding: 3% 3% 3% 3%; border: 2px solid #0D6EFD; border-radius: 15px;">
      ...
      <div class="d-flex mb-3 pr-2">
          <div class="d-flex align-items-center">
              ...
              <select name="status" multiple class="selectpicker mx-1" id="status" data-none-selected-text="Status">
                  ...
                  <option value="0">Ongoing trip</option>
              </select>
              ...
              <select name="" id="sortBy" class="selectpicker mx-1 w-70">
                  ...
                  <option value="tripfrom">Trip from</option>
                  <option value="tripto">Trip to</option>
      ...
      <table class="table table-striped table-hover" style="width: 100%; border-color: grey;">
        <tr>
            <!-- <th>ID</th> -->
            <th style="font-size: 12px;">Driver Name</th>
            <th style="font-size: 12px;">Client Name</th>
            <th style="font-size: 12px;">Trip From</th>
            <th style="font-size: 12px;">Trip To</th>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-success cash_paybtn">Pay</button>
      </div>
      </div>
    </div>
  </div>
...
<script type="text/javascript" src="<?= base_url() ?>JS/bookingpaymentJS.js"></script>
</html>