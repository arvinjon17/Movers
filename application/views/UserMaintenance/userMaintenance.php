  ...
  <nav
    ...
    <div class="container-fluid">
      ...
      <div style="margin-left: 4%;">
        <i class="fas fa-home fa-fw me-3"></i><span>Home > <b>User Maintenance</b></span>
      </div>
...
<main style="margin-top: 6%;">
    ...
    <div style="margin: 3% 3% 3% 3%; padding: 3% 3% 3% 3%; border: 2px solid #0D6EFD; border-radius: 15px;">
      ...
      <div>
          <button class="px-2 py-2 btn btn-primary btn-sm ml-2" id="adduserbtn"><i class="bi bi-file-earmark-plus" style="font-size: 15px; padding-right: 5px;"></i>Add User</button>
      </div>
      <div class="d-flex mb-3 pr-2">
          <div class="d-flex align-items-center">
              ...
              <select name="" id="sortBy" class="selectpicker mx-1 w-70">
                  ...
                  <option value="updatedby">Updated Date</option>
                  <option value="updateddate">Updated Date</option>
                  <option value="activeflag">Status</option>
              </select>
      ...
      <table class="table table-striped table-hover" style="width: 100%; border-color: grey;">
        <tr>
            ...
            <th style="font-size: 12px;">Birthday</th>
    ...
    <!-- Modal -->
<div class="modal" id="addusermodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header bg-primary">
        <h5 class="modal-title text-light" id="modaltitle">Add User</h5>
        <button type="button" class="btn btn-danger" onclick="$('#addusermodal').modal('hide')">
            ...
            <div class="card bg-glass">
              <div class="card-body px-4 py-5">
                  ...
                  <div class="text-center" style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                    <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block align-items-center" style="padding: 10px 50px; display: block;" id="adduser">
                        Submit
                    </button>
                    <button type="button" data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-block align-items-center" style="padding: 10px 50px; display: none;" id="edituser">
                        Submit Changes
                    </button>
                </div>
              </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary align-item-start" onclick="$('#addusermodal').modal('hide')">Close</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal" id="promptMessage" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-primary" id="disableuser">Yes</button>
        <button class="btn btn-primary" id="activateuser">Yes</button>
...
<script type="text/javascript" src="<?= base_url() ?>JS/userMaintenanceJS.js"></script>
</html>